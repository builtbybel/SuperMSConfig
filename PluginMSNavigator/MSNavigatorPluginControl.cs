...
{
    public partial class MSNavigatorPluginControl : UserControl, IPlugin
    {
        ...
        public string PluginName => "Microsoft Navigator";
        public string PluginVersion => "1.0";
        public string PluginInfo => "Windows Navigator is your modern, assistant for Windows. Like Clippy, Butler handles simple requests to manage your system—install apps, tweak settings, and more.";
        ...
        public MSNavigatorPluginControl()
        {
            InitializeComponent();
            LoadData();
            BackColor =
        ...
        private void searchTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            btnSend.Enabled = !string.IsNullOrWhiteSpace(searchTextBox.Text);
        ...
        {
            searchTextBox.Text = "Type your question";
